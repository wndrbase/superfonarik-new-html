...
*/;var SF={};!function(){function e(){var e=document.createElement("div");e.style.overflowY="scroll",e.style.width="50px",e.style.height="50px",document.body.appendChild(e);var t=e.offsetWidth-e.clientWidth;document.body.removeChild(e);for(var n=0,o=document.querySelector(".main").children[n];null===o.offsetParent;)o=document.querySelector(".main").children[++n];document.documentElement.style.setProperty("--widthCenter",o.clientWidth+"px"),document.documentElement.style.setProperty("--widthScrollBar",t+"px")}SF.resizeTimeout=null,SF.windowWidthOLd=window.innerWidth,window.addEventListener("resize",function(){window.requestAnimationFrame(function(){SF.resizeTimeout||(SF.resizeTimeout=setTimeout(function(){SF.resizeTimeout=null,SF.windowWidthOLd!==window.innerWidth&&(SF.windowWidthOLd=window.innerWidth,PubSub.publish("windowWidthResize"))},100))})}),window.addEventListener("scroll",function(){window.requestAnimationFrame(function(){PubSub.publish("windowScroll")})}),window.addEventListener("DOMContentLoaded",function(){PubSub.publish("DOMContentLoaded")}),window.addEventListener("load",function(){PubSub.publish("pageLoad")}),PubSub.subscribe("windowWidthResize",function(){e()}),e(),SF.cssAnimation=function(e){var t,n,o=document.createElement("cssanimation");switch(e){case"animation":t={animation:"animationend",OAnimation:"oAnimationEnd",MozAnimation:"animationend",WebkitAnimation:"webkitAnimationEnd"};break;case"transition":t={transition:"transitionend",OTransition:"oTransitionEnd",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"}}for(n in t)if(void 0!==o.style[n])return t[n]},SF.isInViewport=function(e){var t=e.getBoundingClientRect();return t.top>=0&&t.bottom<=window.innerHeight},SF.sepNumber=function(e){return(e=parseInt(e,10).toString()).replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g,"$1 ")},SF.strToNumber=function(e){return parseInt(e.replace(/\s+/g,""),10)}}(),function(e){if(e){var t=document.querySelectorAll(".address__item"),n=e.querySelectorAll(".btn");PubSub.subscribe("windowScroll",function(){for(var o=0;o<t.length;o++)if(t[o].getBoundingClientRect().bottom>e.clientHeight){Array.prototype.forEach.call(n,function(e,t){e.classList.toggle("is-active",t===o)});break}})}}(document.querySelector(".address__city")),document.querySelectorAll(".address-shop").length&&document.querySelector(".address").addEventListener("click",function(e){var t=e.target.closest("[data-shop]");if(t){var n=t.getAttribute("data-shop");PubSub.publish("addressShop",n)}}),function(e){if("IntersectionObserver"in window){new IntersectionObserver(function(e,t){Array.prototype.forEach.call(e,function(e){document.body.classList.toggle("bg-footer",e.intersectionRatio>.1)})},{root:null,rootMargin:"0px",threshold:[.1]}).observe(e)}}(document.querySelector(".footer")),function(e){var t=document.querySelectorAll(".slider-range");if(t.length){var n=document.createElement("script");n.type="text/javascript",n.async=!0,n.src="/js/nouislider.min.js",n.onload=function(){SF.sliderRangeInit(t)},document.head.appendChild(n)}}(document.querySelector(".filter")),SF.sliderRangeInit=function(e){Array.prototype.forEach.call(e,function(e){var t=parseInt(e.getAttribute("data-min"),10),n=parseInt(e.getAttribute("data-max"),10),o=e.querySelector(".slider-range__value-min"),r=e.querySelector(".slider-range__value-max"),i=e.getAttribute("data-start"),a={min:t,max:n},s=e.querySelectorAll(".slider-range__input-control .input"),l=e.querySelector(".slider-range__input-min"),c=e.querySelector(".slider-range__input-max"),u=e.querySelector(".slider-range__track");i=i?(i=i.split(",")).map(function(e){return parseInt(e,10)}):[t,n],u.classList.contains("slider-range__track--nonlinear-price")&&(a=sliderNonlinearPrice),noUiSlider.create(u,{start:i,connect:!0,range:a}),u.noUiSlider.on("slide",function(e){l.value=SF.sepNumber(parseInt(e[0],10)),c.value=SF.sepNumber(parseInt(e[1],10))});var d=new CustomEvent("change",{detail:{hazcheeseburger:!0}});function p(e,t){o.value=parseInt(e,10),r.value=parseInt(t,10),o.dispatchEvent(d),r.dispatchEvent(d)}u.noUiSlider.on("change",function(e){p(e[0],e[1])}),Array.prototype.forEach.call(s,function(e){e.addEventListener("focus",function(){setTimeout(function(){e.setSelectionRange(0,99)},100)}),e.addEventListener("keyup",function(t){13==t.keyCode&&(e.blur(),t.preventDefault())}),e.addEventListener("blur",function(){var e=parseInt(SF.strToNumber(l.value),10),o=parseInt(SF.strToNumber(c.value),10);e<t&&(e=t,this.value=t),o>n&&(o=n,this.value=n),e<o&&(u.noUiSlider.set([e,o]),p(e,o))})}),PubSub.subscribe("filterFormReset",function(){u.noUiSlider.reset()})})},function(e){e&&e.addEventListener("click",function(){document.body.classList.add("filter-show");var e=document.querySelector(".main").getBoundingClientRect().top;e<0&&window.scrollTo(0,window.pageYOffset+e)})}(document.querySelector(".js-open-filter")),function(e){e&&e.addEventListener("reset",function(){PubSub.publish("filterFormReset")})}(document.querySelector(".filter__form")),function(e){e.length&&Array.prototype.forEach.call(e,function(e){e.addEventListener("change",function(){SF.modalShow("rules")})})}(document.querySelectorAll(".js-checkbox-rule")),function(e){e.length&&Array.prototype.forEach.call(e,function(e){e.addEventListener("click",function(){var t=e.getAttribute("data-change"),n=e.getAttribute("data-checked"),o=document.querySelectorAll("."+t);Array.prototype.forEach.call(o,function(e){e.checked="true"==n})})})}(document.querySelectorAll(".js-btn-rules")),function(e){e.length&&Array.prototype.forEach.call(e,function(e){e.addEventListener("submit",function(t){t.preventDefault(),document.querySelector("#popup_notify_url").value=e.getAttribute("data-url"),SF.modalShow("notify")})})}(document.querySelectorAll(".js-modal-notify")),function(e){e.length&&Array.prototype.forEach.call(e,function(e){e.addEventListener("submit",function(t){t.preventDefault(),document.querySelector("#popup_one_click-buy").value=e.getAttribute("data-id"),SF.modalShow("one-click-buy")})})}(document.querySelectorAll(".js-modal-one-click-buy")),function(e){e.length&&Array.prototype.forEach.call(e,function(e){e.addEventListener("submit",function(t){t.preventDefault(),document.querySelector("#popup_pre_order").value=e.getAttribute("data-id"),SF.modalShow("pre-order")})})}(document.querySelectorAll(".js-modal-pre-order")),function(e){function t(e,t){e.parentNode.classList.toggle("input-label--no-empty",e.value),t&&null!==e.getAttribute("required")&&e.parentNode.classList.toggle("input-label--error",!e.value)}e.length&&Array.prototype.forEach.call(e,function(e){e.addEventListener("focus",function(){t(e)}),e.addEventListener("keyup",function(){t(e,!0)}),e.addEventListener("blur",function(){t(e,!0)}),t(e),PubSub.subscribe("DOMContentLoaded",function(){t(e)})})}(document.querySelectorAll(".input-label__input")),function(e){e&&e.querySelector(".infomess__close").addEventListener("click",function(){e.style.marginTop="-"+e.clientHeight+"px",Cookies.set("BITRIX_SM_infomessCookie",e.getAttribute("data-time")),setTimeout(function(){e.classList.add("hide")},3e3)})}(document.querySelector(".infomess")),document.addEventListener("click",function(e){(e.target.closest(".btn-menu-toggle")||e.target.classList.contains("menu-show"))&&(SF.OpenMenu?(document.body.classList.remove("menu-show"),window.scrollTo(0,SF.windowScrollOld),SF.OpenMenu=!1):(SF.OpenMenu=!0,SF.windowScrollOld=window.pageYOffset,window.scrollTo(0,0),document.body.classList.add("menu-show")))}),function(e){if(e){var t=e.querySelectorAll(".modal__item"),n=document.querySelectorAll("[data-modal]"),o=document.querySelector(".wrapper"),r=0;e.addEventListener("click",function(e){(e.target.classList.contains("modal")||e.target.closest(".modal__close"))&&SF.hideModal()}),SF.hideModal=function(){e.classList.add("visuallyhidden"),document.body.classList.remove("modal-show"),o.style.top=0,window.scrollTo(0,r),SF.activeModal=!1,setTimeout(function(){document.documentElement.classList.remove("scroll-behavior-off")}),document.getElementById("modal-video").innerHTML=""},SF.modalShow=function(n,i,a){document.documentElement.classList.add("scroll-behavior-off"),SF.activeModal||(r=window.pageYOffset,o.style.top=-r+"px"),SF.activeModal=e.querySelector(".modal__item--"+n),"message"==n&&(SF.activeModal.querySelector(".modal-form__title").innerHTML=i||"",SF.activeModal.querySelector(".modal-form__text").innerHTML=a||""),e.classList.toggle("modal--wide",SF.activeModal.classList.contains("is-wide")),e.classList.toggle("modal--video",SF.activeModal.classList.contains("is-video")),Array.prototype.forEach.call(t,function(e){e.classList.toggle("visuallyhidden",e!==SF.activeModal)}),e.classList.remove("visuallyhidden"),document.body.classList.remove("menu-show"),document.body.classList.add("modal-show"),window.scrollTo(0,0),SF.activeModal.focus()},Array.prototype.forEach.call(n,function(e){e.addEventListener("click",function(e){e.preventDefault(),SF.modalShow(this.getAttribute("data-modal"))})})}}(document.querySelector(".modal")),function(e){e.length&&Array.prototype.forEach.call(e,function(e){var t=e.querySelector(".more-slide__btn"),n=e.querySelector(".more-slide__box"),o=e.querySelector(".more-slide__inner");t.addEventListener("click",function(){var e=o.clientHeight;t.classList.contains("is-open")&&(e=0,n.classList.remove("is-open")),n.style.height=e+"px",t.classList.toggle("is-open")}),n.addEventListener(SF.cssAnimation("transition"),function(){t.classList.contains("is-open")&&n.classList.add("is-open")})})}(document.querySelectorAll(".more-slide")),function(e){if(e){var t=document.querySelector("#modal-gallery");function n(e){if(document.querySelector("#gallery-product")){var n={img:[]},o=document.querySelector("#gallery-template").innerHTML,r=document.querySelectorAll("#gallery-product .swiper-slide"),i=e.closest(".swiper-slide").getAttribute("data-swiper-slide-index");if(t.querySelector(".swiper-container--gallery"))return void function(e){t.querySelector(".swiper-container--gallery").swiper.slideToLoop(parseInt(e),0)}(i);r.forEach(function(e){var t=parseInt(e.getAttribute("data-swiper-slide-index")),o=e.querySelector(".product__img-link");n.img[t]={img1x:o.getAttribute("data-img1x"),img2x:o.getAttribute("data-img2x"),webp1x:o.getAttribute("data-webp1x"),webp2x:o.getAttribute("data-webp2x")}}),t.innerHTML=Mustache.render(o,n),t.querySelector(".swiper-container--gallery").setAttribute("data-start-slide",i),SF.swiper(t.querySelectorAll(".swiper-container--gallery"))}else{o=document.querySelector("#gallery-template").innerHTML,n={img1x:e.getAttribute("data-img1x"),img2x:e.getAttribute("data-img2x"),webp1x:e.getAttribute("data-webp1x"),webp2x:e.getAttribute("data-webp2x")};t.innerHTML=Mustache.render(o,n)}}e.addEventListener("click",function(e){if(e.preventDefault(),!(window.innerWidth<768)){var t=e.target.closest(".product__img-link");if(t)return SF.modalShow("gallery"),void(window.Swiper?n(t):PubSub.subscribe("swiperJsLoad",function(){n(t)}));var o=e.target.closest("[data-preview]");o&&document.querySelector(".swiper-container--product").swiper&&document.querySelector(".swiper-container--product").swiper.slideToLoop(parseInt(o.getAttribute("data-preview")));var r=e.target.closest(".product__preview-many");r&&r.remove()}})}}(document.querySelector(".product__img")),function(e){if(e){var t=e.querySelectorAll("a"),n=[],o=0;Array.prototype.forEach.call(t,function(e){var t=e.getAttribute("href"),o=document.querySelector(t);o&&n.push(o)}),PubSub.subscribe("windowScroll",function(){e.classList.toggle("product__nav--fixed",e.getBoundingClientRect().top<=0);var r=0;n.forEach(function(e,t){e.getBoundingClientRect().top<1&&(r=t)}),o!=r&&(o=r,Array.prototype.forEach.call(t,function(e,t){e.classList.toggle("is-active",t==o)}))})}}(document.querySelector(".product__nav")),function(e){e.length&&Array.prototype.forEach.call(e,function(e){e.addEventListener("click",function(t){t.preventDefault();var n=document.createElement("img"),o=document.querySelector("#modal-photo");n.src=e.getAttribute("href"),o.innerHTML="",o.appendChild(n),SF.modalShow("photo")})})}(document.querySelectorAll(".js-img-modal")),function(e){e&&Array.prototype.forEach.call(e,function(e){e.addEventListener("change",function(){location.assign(e.value)})})}(document.querySelectorAll(".sort-mobile__select")),SF.swiper=function(e){Array.prototype.forEach.call(e,function(e){var t,n=null,o=null,r=document.createElement("div"),i=document.createElement("div"),a=document.createElement("div"),s=document.createElement("button"),l=document.createElement("button"),c=e.querySelectorAll(".swiper-slide").length,u=e.getAttribute("data-start-slide")?parseInt(e.getAttribute("data-start-slide")):0,d={loop:!0,preloadImages:!1,pagination:{clickable:!0,bulletElement:"button",bulletClass:"button",bulletActiveClass:"is-active",el:i},navigation:{nextEl:s,prevEl:l},autoplay:{delay:6e3}},p=e.classList.contains("swiper-container--gallery"),f=e.classList.contains("swiper-container--related"),m=e.classList.contains("swiper-container--carousel"),h=e.classList.contains("swiper-container--home-slider"),y=e.classList.contains("swiper-container--product");if(i.className="swiper-pagination",r.className="swiper-controls",a.className="swiper-navigation",l.className="swiper-button-prev button",s.className="swiper-button-next button",l.innerHTML='<svg width="19" height="24" viewBox="0 0 19 24"><path d="M12.528,23.999 L18.272,18.488 L11.243,12.706 L18.272,5.512 L12.529,-0.000 L-0.002,11.998 L12.528,23.999 Z"/></svg>',s.innerHTML='<svg width="19" height="24" viewBox="0 0 19 24"><path d="M6.471,0.001 L0.728,5.511 L7.756,11.294 L0.728,18.487 L6.470,23.999 L19.001,12.000 L6.471,0.001 Z"/></svg>',a.appendChild(l),a.appendChild(s),r.appendChild(a),r.appendChild(i),e.parentNode.appendChild(r),Array.prototype.forEach.call(e.querySelectorAll('[loading="lazy"]'),function(e){e.setAttribute("loading","eager")}),(t=function(){n&&(n.destroy(!1,!0),n=void 0)})(),h&&(r.classList.add("center"),o=function(){console.log("homeSlider"),new Swiper(e,d),o=null}),f&&(e.parentNode.parentNode.appendChild(r),d.loopFillGroupWithBlank=!0,s.classList.add("hide"),l.classList.add("hide"),o=function(){t(),s.classList.add("hide"),l.classList.add("hide"),e.parentNode.parentNode.classList.remove("swiper-container-style"),c>4&&window.innerWidth>=1200?(e.parentNode.parentNode.classList.add("swiper-container-style"),s.classList.remove("hide"),l.classList.remove("hide"),d.slidesPerView=4,d.slidesPerGroup=4,d.spaceBetween=48,n=new Swiper(e,d)):c>3&&window.innerWidth<1200&&window.innerWidth>=768?(e.parentNode.parentNode.classList.add("swiper-container-style"),s.classList.remove("hide"),l.classList.remove("hide"),d.slidesPerView=3,d.slidesPerGroup=3,d.spaceBetween=20,n=new Swiper(e,d)):c>2&&window.innerWidth<768&&(e.parentNode.parentNode.classList.add("swiper-container-style"),i.classList.remove("hide"),d.slidesPerView=2,d.slidesPerGroup=2,d.spaceBetween=10,n=new Swiper(e,d))}),m&&(d.autoHeight=!1,d.slidesPerView=3,d.slidesPerGroup=3,d.spaceBetween=59,d.loopFillGroupWithBlank=!0,d.breakpoints={320:{slidesPerView:"auto",slidesPerGroup:1,spaceBetween:0},768:{slidesPerView:3,slidesPerGroup:3,spaceBetween:20},1200:{spaceBetween:59}},o=function(){console.log("carousel"),new Swiper(e,d),o=null}),y&&(d.autoplay=!1,o=function(){console.log("product"),new Swiper(e,d),o=null}),p&&(o=function(){n||(console.log("gallery"),n=new Swiper(e,{loop:!0,initialSlide:u,navigation:{nextEl:s,prevEl:l}}))}),PubSub.subscribe("windowWidthResize",function(){window.Swiper&&o&&o()}),window.Swiper&&o?o():PubSub.subscribe("swiperJsLoad",o),!SF.swiper.init){SF.swiper.init=!0;var v=document.createElement("script");v.type="text/javascript",v.async=!0,v.src="/js/swiper.min.js",v.onload=function(){PubSub.publish("swiperJsLoad")},document.head.appendChild(v)}})},document.querySelector(".swiper-container")&&SF.swiper(document.querySelectorAll(".swiper-container")),SF.tabs=function(e){Array.prototype.forEach.call(e,function(e){var t=e.querySelectorAll(".tabs__btn"),n=e.querySelectorAll(".tabs__item"),o=document.createElement("div");Array.prototype.forEach.call(t,function(r,i){e.classList.contains("tabs--btn-no-move")||o.appendChild(r),r.addEventListener("click",function(){Array.prototype.forEach.call(t,function(e,t){t==i?(e.classList.add("tabs__btn--active"),n[t].classList.remove("visuallyhidden")):(e.classList.remove("tabs__btn--active"),n[t].classList.add("visuallyhidden"))})})}),e.classList.contains("tabs--btn-no-move")||(o.classList.add("tabs__nav"),e.insertBefore(o,n[0]))})},document.querySelectorAll(".tabs").length&&SF.tabs(document.querySelectorAll(".tabs")),SF.tabsHash=function(e){function t(e){return"/"==e.slice(-1)&&(e=e.slice(0,-1)),e}function n(){var e=t(location.hash);PubSub.publish("tab-show"+e,e.slice(1))}Array.prototype.forEach.call(e,function(e){var o=e.querySelectorAll(".tabs-hash__btn"),r=e.querySelectorAll(".tabs-hash__item"),i=document.createElement("div");Array.prototype.forEach.call(o,function(e){var n=document.createElement("a"),o=t(e.closest(".tabs-hash__item").querySelector(".hash-detect").getAttribute("id"));n.setAttribute("href","#"+o),n.className="tabs-hash__btn h4",n.innerHTML=e.innerHTML,e.classList.contains("tabs-hash__btn--active")&&n.classList.add("tabs-hash__btn--active"),i.appendChild(n),e.classList.add("hide")}),i.classList.add("tabs-hash__nav"),e.insertBefore(i,r[0]),o=i.querySelectorAll(".tabs-hash__btn"),Array.prototype.forEach.call(r,function(e){var n=t(e.querySelector(".hash-detect").getAttribute("id"));PubSub.subscribe("tab-show#"+n,function(e,t){Array.prototype.forEach.call(r,function(e,n){e.querySelector(".hash-detect").getAttribute("id")===t?(e.classList.remove("visuallyhidden"),o[n].classList.add("tabs-hash__btn--active")):(e.classList.add("visuallyhidden"),o[n].classList.remove("tabs-hash__btn--active"))})})}),window.addEventListener("popstate",function(){n()}),n()})},document.querySelectorAll(".tabs-hash").length&&SF.tabsHash(document.querySelectorAll(".tabs-hash")),function(e){e.length&&Array.prototype.forEach.call(e,function(e){var t=e.querySelector("img").src.match(/https:\/\/i\.ytimg\.com\/vi\/([a-zA-Z0-9_-]+)\/maxresdefault\.jpg/i)[1];e.addEventListener("click",function(e){e.preventDefault();var n=document.createElement("iframe");n.setAttribute("allowfullscreen","allowfullscreen"),n.setAttribute("allow","autoplay"),n.src="https://www.youtube.com/embed/"+t+"?rel=0&showinfo=0&autoplay=1",document.getElementById("modal-video").appendChild(n),SF.modalShow("video")})})}(document.querySelectorAll(".link-video")),function(e){if(e){var t=e.querySelector(".tabs-top__nav"),n=t.querySelectorAll(".tabs-top__btn");items=e.querySelectorAll(".tabs-top__item"),PubSub.subscribe("windowScroll",function(){for(var e=0;e<items.length;e++)if(items[e].getBoundingClientRect().bottom>t.clientHeight){Array.prototype.forEach.call(n,function(t,n){t.classList.toggle("is-active",n===e)});break}})}}(document.querySelector(".tabs-top"));